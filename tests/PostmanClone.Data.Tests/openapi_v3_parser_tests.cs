...
public class openapi_v3_parser_tests
{
    private readonly openapi_v3_parser _parser = new();

    [Fact]
    public void can_parse_returns_true_for_openapi_v3()
    {
        // Arrange
        var json = """
        {
    ...
    [Fact]
    public void can_parse_returns_true_for_openapi_v3_1()
    {
        // Arrange
        var json = """
        {
    ...
    [Fact]
    public void can_parse_returns_false_for_swagger_v2()
    {
        // Arrange
        var json = """
        {
    ...
    [Fact]
    public void parse_extracts_base_url_from_servers()
    {
        // Arrange
        var json = """
        {
    ...
    [Fact]
    public void parse_handles_request_body_with_json()
    {
        // Arrange
        var json = """
        {
    ...
    [Fact]
    public void parse_handles_bearer_authentication()
    {
        // Arrange
        var json = """
        {
        ...
        result.auth!.type.Should().Be(auth_type.bearer);
        result.auth.bearer.Should().NotBeNull();
        result.auth.bearer!.token.Should().Be("{{bearer_token}}");
    }
